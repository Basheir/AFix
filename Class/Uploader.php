...
class FileUpload {
    public $uploadDir;                    // Filename of the uploaded file
    public $allowedExtensions;                    // Size of uploaded file in bytes
    public $sizeLimit = 10485760;               // File extension of uploaded file
public $newFileName;
        public $corsInputName = 'XHR_CORS_TARGETORIGIN';                   // Path to newly uploaded file (after upload completed)
        public $uploadName = 'uploadfile';                    // Error message if handleUpload() returns false (use getErrorMsg() to retrieve)
private $fileName;
