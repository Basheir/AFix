...
(function (b) {
    b.fn.waitMe = function (p) {
        return this.each(function () {
            var h = b(this), z, v, e, w = !1, t = "background-color", q = "", r = "", x, f, d, c, y, m = {
                init: function () {
                    function A(a) {
                    ...
                    if (0 < e) {
                        ...
                        if ("img" == c.effect)r = '<img src="' + c.source + '" style="' + d + '">'; else for (a = 1; a <= e; ++a)b.isArray(c.color) ? (g = c.color[a], void 0 == g && (g = "#000")) : g = c.color, r = w ? r + ('<div class="waitMe_progress_elem' + a + '" style="' + d + '"><div style="' + t + ":" + g + '"></div></div>') : r + ('<div class="waitMe_progress_elem' +
                        a + '" style="' + t + ":" + g + ";" + d + '"></div>');
                    ...
                    l.on("destroyed", function () {
                        if (c.onClose && b.isFunction(c.onClose))c.onClose();
                        l.trigger("close")
                    });
            ...
            if (m[p])return m[p].apply(this, Array.prototype.slice.call(arguments, 1));
            if ("object" === typeof p || !p)return m.init.apply(this, arguments)
        })
    };
